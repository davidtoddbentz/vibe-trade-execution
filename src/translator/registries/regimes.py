...
RegimeIndicatorHandler = Callable[[RegimeCondition], list[IndicatorUnion]]
...
def _trend_ma_relation(regime: RegimeCondition) -> list[IndicatorUnion]:
...
def _dist_from_vwap_pct(regime: RegimeCondition) -> list[IndicatorUnion]:
    """dist_from_vwap_pct needs VWAP indicator."""
    return [VWAP(id="vwap")]


def _ret_pct(regime: RegimeCondition) -> list[IndicatorUnion]:
...
def _volume_pctile(regime: RegimeCondition) -> list[IndicatorUnion]:
...
def _liquidity_sweep(regime: RegimeCondition) -> list[IndicatorUnion]:
...
def _price_level_touch(regime: RegimeCondition) -> list[IndicatorUnion]:
...
def _price_level_cross(regime: RegimeCondition) -> list[IndicatorUnion]:
...
def _flag_pattern(regime: RegimeCondition) -> list[IndicatorUnion]:
...
def _no_indicators(regime: RegimeCondition) -> list[IndicatorUnion]:
...
def get_regime_indicators(regime: RegimeCondition) -> list[IndicatorUnion]:

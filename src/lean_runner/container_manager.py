...
class ContainerManager:
    ...
    def start_strategy(
        ...
        cmd = [
            ...
            "--name", container_name,
            "-v", f"{strategy_dir}:/Lean/Algorithm.Python",
            "-v", f"{self.project_root / 'lean' / 'Data'}:/Data",
            "-v", f"{self.project_root / 'lean' / 'Results' / strategy_id}:/Results",
            # Add environment variables
            "-e", f"STRATEGY_ID={strategy_id}",
            "-e", f"ALGORITHM_NAME={algorithm_name}",
            self.lean_image,

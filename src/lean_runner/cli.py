...
def cmd_start(args):
    ...
    algorithm_file = Path(__file__).parent.parent.parent / "lean" / "Algorithms" / f"{args.algorithm}.py"
...
def main():
    ...
    start_parser.add_argument("--algorithm", required=True, help="Algorithm name (e.g., SimpleMaCrossover)")
